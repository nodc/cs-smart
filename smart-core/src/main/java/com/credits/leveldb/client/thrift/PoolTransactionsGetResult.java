...
public class PoolTransactionsGetResult implements org.apache.thrift.TBase<PoolTransactionsGetResult, PoolTransactionsGetResult._Fields>, java.io.Serializable, Cloneable, Comparable<PoolTransactionsGetResult> {
  ...
  public java.util.List<Transaction> transactions; // required
  ...
  public PoolTransactionsGetResult(PoolTransactionsGetResult other) {
    ...
    if (other.isSetTransactions()) {
      java.util.List<Transaction> __this__transactions = new java.util.ArrayList<Transaction>(other.transactions.size());
  ...
  public PoolTransactionsGetResult setTransactions(java.util.List<Transaction> transactions) {
    this.transactions = transactions;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case TRANSACTIONS:
      if (value == null) {
        ...
        setTransactions((java.util.List<Transaction>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transactions = new java.util.ArrayList<Transaction>(_list34.size);
                Transaction _elem35;
                for (int _i36 = 0; _i36 < _list34.size; ++_i36)
                {
                  _elem35 = new Transaction();
                  _elem35.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PoolTransactionsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transactions != null) {
        oprot.writeFieldBegin(TRANSACTIONS_FIELD_DESC);
        {
          ...
          for (Transaction _iter37 : struct.transactions)
          {
            _iter37.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetTransactions()) {
        {
          ...
          for (Transaction _iter38 : struct.transactions)
          {
            _iter38.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.transactions = new java.util.ArrayList<Transaction>(_list39.size);
          Transaction _elem40;
