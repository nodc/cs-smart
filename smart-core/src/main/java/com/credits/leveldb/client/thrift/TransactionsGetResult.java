...
public class TransactionsGetResult implements org.apache.thrift.TBase<TransactionsGetResult, TransactionsGetResult._Fields>, java.io.Serializable, Cloneable, Comparable<TransactionsGetResult> {
  ...
  public TransactionsGetResult setTransactions(java.util.List<Transaction> transactions) {
    this.transactions = transactions;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transactions = new java.util.ArrayList<Transaction>(_list18.size);
                Transaction _elem19;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransactionsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transactions != null) {
        oprot.writeFieldBegin(TRANSACTIONS_FIELD_DESC);
        {
          ...
          for (Transaction _iter21 : struct.transactions)
          {
            _iter21.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetTransactions()) {
        {
          ...
          for (Transaction _iter22 : struct.transactions)
          {
            _iter22.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transactions = new java.util.ArrayList<Transaction>(_list23.size);
          Transaction _elem24;
