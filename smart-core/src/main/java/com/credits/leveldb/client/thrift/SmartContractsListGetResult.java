...
public class SmartContractsListGetResult implements org.apache.thrift.TBase<SmartContractsListGetResult, SmartContractsListGetResult._Fields>, java.io.Serializable, Cloneable, Comparable<SmartContractsListGetResult> {
  ...
  static {
    ...
    tmpMap.put(_Fields.SMART_CONTRACTS_LIST, new org.apache.thrift.meta_data.FieldMetaData("smartContractsList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.LIST        , "SmartContractsList")));
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.smartContractsList = new java.util.ArrayList<SmartContract>(_list66.size);
                SmartContract _elem67;
                for (int _i68 = 0; _i68 < _list66.size; ++_i68)
                {
                  _elem67 = new SmartContract();
                  _elem67.read(iprot);
                  struct.smartContractsList.add(_elem67);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractsListGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.smartContractsList != null) {
        oprot.writeFieldBegin(SMART_CONTRACTS_LIST_FIELD_DESC);
        {
          ...
          for (SmartContract _iter69 : struct.smartContractsList)
          {
            _iter69.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSmartContractsList()) {
        {
          ...
          for (SmartContract _iter70 : struct.smartContractsList)
          {
            _iter70.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.smartContractsList = new java.util.ArrayList<SmartContract>(_list71.size);
          SmartContract _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = new SmartContract();
            _elem72.read(iprot);
            struct.smartContractsList.add(_elem72);
          }
        }
        struct.setSmartContractsListIsSet(true);
      }
