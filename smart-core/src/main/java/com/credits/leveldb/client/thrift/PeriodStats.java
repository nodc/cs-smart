...
public class PeriodStats implements org.apache.thrift.TBase<PeriodStats, PeriodStats._Fields>, java.io.Serializable, Cloneable, Comparable<PeriodStats> {
  ...
  public java.util.Map<java.lang.String,CumulativeAmount> balancePerCurrency; // required
  ...
  public PeriodStats(
    ...
    java.util.Map<java.lang.String,CumulativeAmount> balancePerCurrency,
  ...
  public PeriodStats(PeriodStats other) {
    ...
    if (other.isSetBalancePerCurrency()) {
      java.util.Map<java.lang.String,CumulativeAmount> __this__balancePerCurrency = new java.util.HashMap<java.lang.String,CumulativeAmount>(other.balancePerCurrency.size());
      for (java.util.Map.Entry<java.lang.String, CumulativeAmount> other_element : other.balancePerCurrency.entrySet()) {

        java.lang.String other_element_key = other_element.getKey();
        CumulativeAmount other_element_value = other_element.getValue();

        java.lang.String __this__balancePerCurrency_copy_key = other_element_key;
  ...
  public void putToBalancePerCurrency(java.lang.String key, CumulativeAmount val) {
    if (this.balancePerCurrency == null) {
      this.balancePerCurrency = new java.util.HashMap<java.lang.String,CumulativeAmount>();
    }
    this.balancePerCurrency.put(key, val);
  }

  public java.util.Map<java.lang.String,CumulativeAmount> getBalancePerCurrency() {
    return this.balancePerCurrency;
  }

  public PeriodStats setBalancePerCurrency(java.util.Map<java.lang.String,CumulativeAmount> balancePerCurrency) {
    this.balancePerCurrency = balancePerCurrency;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case BALANCE_PER_CURRENCY:
      if (value == null) {
        ...
        setBalancePerCurrency((java.util.Map<java.lang.String,CumulativeAmount>)value);
      }
      break;
  ...
  private static class PeriodStatsStandardScheme extends org.apache.thrift.scheme.StandardScheme<PeriodStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.balancePerCurrency = new java.util.HashMap<java.lang.String,CumulativeAmount>(2*_map8.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PeriodStats struct) throws org.apache.thrift.TException {
      ...
      if (struct.balancePerCurrency != null) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, struct.balancePerCurrency.size()));
          for (java.util.Map.Entry<java.lang.String, CumulativeAmount> _iter12 : struct.balancePerCurrency.entrySet())
          {
      ...
      if (struct.isSetBalancePerCurrency()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, CumulativeAmount> _iter13 : struct.balancePerCurrency.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.balancePerCurrency = new java.util.HashMap<java.lang.String,CumulativeAmount>(2*_map14.size);
